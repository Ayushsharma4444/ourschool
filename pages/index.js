                    ...
                    <SwiperSlide className="owl-item">
                      <div className="item-slider-1">
                        <div className="box-content">
                          ...
                          <ul>
                            ...
                            <li className="st-3 fx">
                              <i className="fas fa-check" />
                              <p className="clr-pri-2">Smart Classroom</p>
                            </li>
                          </ul>
                        ...
                        <div className="box-feature">
                          <div className="image">
                            <img
                              src="https://kinco.vercel.app/assets/images/common/slider-1.png"
                              alt="Image"
                            />
                          </div>
                        </div>
          ...
          <div className="row">
            <div className="col-12">
              <div className="sc-about-3">
                ...
                >
                  <img src="https://kinco.vercel.app/assets/images/pattern/about-us-3.png" alt="Image" />
                </div>
                  ...
                  >
                    <SwiperSlide>
                      ...
                      >
                        <div className="box-feature">
                          <img
                            src="https://kinco.vercel.app/assets/images/common/sc-employee-4.jpg"
                            alt="Image"
                          />
                        </div>
                        <div className="box-content st-1">
                          <h4 className="name">
                            <Link href="/teacher-details">
                              <a className="clr-pri-1">Muskan Agarwal</a>
                            </Link>
                          </h4>
                    ...
                    <SwiperSlide>
                      ...
                      >
                        ...
                        <div className="box-content st-2">
                          <h4 className="name">
                            <Link href="/teacher-details">
                              <a className="clr-pri-1">Astha Aggarwal</a>
                            </Link>
                          </h4>
                          <p className="sub f-mulish clr-pri-1">
                            Arts &amp; Drawing
                    ...
                    <SwiperSlide>
                      ...
                      >
                        ...
                        <div className="box-content st-3">
                          <h4 className="name">
                            <Link href="/teacher-details">
                              <a className="clr-pri-1">Komal Chaudhary</a>
                            </Link>
                          </h4>
                          <p className="sub f-mulish clr-pri-1">
                            English Teacher
                    ...
                    <SwiperSlide>
                      ...
                      >
                        ...
                        <div className="box-content st-4">
                          <h4 className="name">
                            <Link href="/teacher-details">
                              <a className="clr-pri-1">Saumya Tripathi</a>
                            </Link>
                          </h4>
                          <p className="sub f-mulish clr-pri-1">
                            Science Teacher
          ...
          <div className="row">
            <div className="col-12">
              <div className="fl-services fx">
                ...
                >
                  <img src="https://kinco.vercel.app/assets/images/pattern/service-2.png" alt="Image" />
                </div>
                <div className="box-content">
                  <div className="title-heading">
                    <div className="sub-heading clr-pri-3 f-mulish">
            ...
            <div className="col-12">
              <div className="title-heading st-3">
                ...
                <h2 className="title clr-pri-2">
                  ...
                  <span className="clr-pri-3">School</span> 
                </h2>
              </div>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="row-form st-1">
                    ...
                    /> */}
                    <select id="program">
                      <option value="class 1" >Applying For........</option>
                      <option value="class 1" >Class 1</option>
                      <option value="class 2" >Class 2</option>
                      <option value="class 3" >Class 3</option>
                      <option value="class 4" >Class 4</option>
                  ...
                  <div className="row-form">
                    <button className="fl-btn st-14">
                      <span className="inner">Apply</span>
                    </button>
                  </div>
                </form>
              </div>
              ...
              >
                <div className="box-feature fx">
                  ...
                  {/* <Link href="/blog-single"> */}
                    <a>
                      <img
                        src="https://kinco.vercel.app/assets/images/common/sc-article-1.jpg"
                        alt="Image"
                      />
                    </a>
                  </Link>
